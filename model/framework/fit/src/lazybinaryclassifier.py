...
train_file = os.path.join(root, "..","data", "manrique_paeruginosa_permeability_standard.csv")
model_folder = os.path.join(root, "..", "..", "..", "checkpoints", "permeability")
...
y = train["permeability_class"].astype(int)
